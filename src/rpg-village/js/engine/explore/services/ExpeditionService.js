...
export class ExpeditionService {
        ...
        const all = [
            {
                ...
                status: 'available',
                requirement: null,
                reward: { gold: 100, items: { material_wood: 20 } },
                stages: [
            ...
            },
            {
                ...
                stages: [
                    { type: 'battle', enemies: ['goblin_scout', 'goblin_scout', 'goblin_scout'] },
                    { type: 'battle', enemies: ['goblin_scout', 'goblin_scout', 'goblin_brute'], isBoss: true }
                ]
            },
            {
    ...
    _createEnemy(templateId, isBoss) {
        ...
        const templates = {
            ...
            goblin_scout: { name: 'Goblin Scout', type: 'humanoid', maxHp: 25, strength: 4, speed: 3 },
            goblin_brute: { name: 'Goblin Brute', type: 'humanoid', maxHp: 50, strength: 6, speed: 1 },
            goblin_king: { name: 'Goblin King', type: 'humanoid', maxHp: 100, strength: 8, speed: 2, isBoss: true }
        };
