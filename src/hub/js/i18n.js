export const TRANSLATIONS = {
  es: {
    ...
    app_rpg_village_title: "RPG Village",
    app_rpg_village_desc: "Construye una aldea, gestiona héroes y conquista expediciones.",
  ...
  en: {
    ...
    app_rpg_village_title: "RPG Village",
    app_rpg_village_desc: "Build a village, manage heroes, and conquer expeditions.",
  ...
  ca: {
    ...
    app_rpg_village_title: "RPG Village",
    app_rpg_village_desc: "Construeix un poble, gestiona herois i conquista expedicions.",
  ...
  eu: {
    ...
    app_rpg_village_title: "RPG Village",
    app_rpg_village_desc: "Eraiki herri bat, kudeatu heroia eta konkistatu espedizioak.",
  ...
  gl: {
    ...
    app_rpg_village_title: "RPG Village",
    app_rpg_village_desc: "Constrúe unha aldea, xestiona heroes e conquista expedicións.",
